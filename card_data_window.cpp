...
Card_data_window::Card_data_window(Card* card,QWidget *parent) :QDialog(parent),ui(new Ui::Card_data_window)
{
    ui->setupUi(this);
...
{
    add_money_window = new Add_money_window(current_card);
